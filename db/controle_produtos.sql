...
CREATE TABLE `produtos` (
  ...
  `preco_prod` varchar(50) DEFAULT NULL,
  `obs_prod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id_prod`)
...
-- Dump completed on 2022-10-03 21:08:32
